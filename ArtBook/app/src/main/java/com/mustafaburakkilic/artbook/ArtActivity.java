package com.mustafaburakkilic.artbook;
...
import com.mustafaburakkilic.artbook.databinding.ActivityArtBinding;
...
public class ArtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (info.equals("new")){
            ...
            try {
                Cursor cursor =
                        database.rawQuery("SELECT * FROM arts WHERE id= ?",new String[]{String.valueOf(ardId)});
                                ...
                                try {
                                    if (Build.VERSION.SDK_INT >= 28) {
                                        ImageDecoder.Source source =
                                                ImageDecoder.createSource(ArtActivity.this.getContentResolver(),imageData);
